 ...
 * @version 1.05.2021
*/ 
public class ChooseDifficultyGui {
	 ...
	 */
	public ChooseDifficultyGui(JFrame frame) {
        this.frame = frame;
	...
	private void initialize() {
		frame.setTitle("ChooseDifficulty");
        ...
        JButton freeWM = new JButton("Easy");
        freeWM.addActionListener( new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
				try {
					new ChooseWordGui("Easy", frame);
        ...
        JButton practiceGame = new JButton("Medium");
        practiceGame.addActionListener( new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
				try {
					new ChooseWordGui("Medium", frame);
				} catch (IOException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
        ...
        JButton myList = new JButton("Hard");
        myList.addActionListener( new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
				try {
					new ChooseWordGui("Hard", frame);
				} catch (IOException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
